...
<div class="content-wrapper">
	  <div class="container-full">
		...
		<section class="invoice printableArea">
			  ...
			  <div class="row">
				<div class="col-12">
			<form method="POST" action="{{ route('transfer.market.payment.store') }}" class="contact-form">
		     @csrf
				...
				<div class="col-12">
				  <div class="page-header">
					<h2 class="d-inline"><span class="font-size-30">Vegitable Retial Market Bulk Sell Invoice</span></h2>
			  ...
			  <div class="row invoice-info">
				<div class="col-md-6 invoice-col">
				  ...
				  <address>
					<strong class="text-blue font-size-24"></strong><br>
					<strong class="d-inline"></strong><br>
					<strong></strong>  
				  </address>
				</div>
				<!-- /.col -->
				...
				@foreach($ecenter as $key => $ecenter)
				  ...
				  <address>
					...
					{{ $ecenter->address}}<br>
					<strong><span class="text-white">Phone:</span> {{ $ecenter->mobile }} &nbsp;&nbsp;&nbsp;&nbsp;<span class="text-white"> Email:</span> {{ $ecenter->email }}</strong>
				  </address>
