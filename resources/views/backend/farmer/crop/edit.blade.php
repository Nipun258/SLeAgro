          ...
          <section class="content">
               ...
               <div class="box">
                    ...
                    <div class="box-body">
                         <div class="row">
                              <div class="col">
                                   <form method="post" action="{{ route('farmer.land.update',$farmer_lands->id)}}">
                                        @csrf
                                        <div class="row">
                                             <div class="col-12">
                                                  <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                 ...
                                                                 <select name="veg_id" id="veg_id" class="form-control">
                                                                  ...
                                                                  @foreach($vegitable as $vegitable)
                                                                   @if($vegitable->id == $farmer_lands->product)
                                                  ...
                                                  <div class="col-md-6">
                                                     <div class="form-group">
                                                                 ...
                                                                 <div class="controls">
                                                                 <input type="text" name="land_acre" class="form-control" value ="{{floor($farmer_lands->area/160) }}">
                                                   ...
                                                   <div class="col-md-6">
                                                     <div class="form-group">
                                                                 ...
                                                                 <div class="controls">
                                                                 <input type="text" name="land_perch" class="form-control" value ="{{fmod($farmer_lands->area,160)}}">
