	...
	<div class="container-full">
		...
		<section class="content">
			...
			<div class="box-header with-border">
			  <h3 class="box-title text-success">Buyer Account Setup</h3>
			  <h6 class="box-subtitle text-info">Fill out necessary data</h6>		
			</div>
			<!-- /.box-header -->
			<div class="box-body wizard-content">

				<form method="POST" action="{{ route('buyer.store') }}" class="contact-form">
					@csrf
								...
								<div class="form-group">
									...
									<select class="custom-select form-control" name="type_id" id="gender">
										<option value="" selected="" disabled="">Select Relavent Buyer Type</option>
                                         <option value="1">Wholesale Buyer</option>
                                        <option value="2">Retials Buyer</option>
									</select>
								</div>
