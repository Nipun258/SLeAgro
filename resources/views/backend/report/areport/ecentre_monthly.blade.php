...
<div class="footer">
  <p><b>Economic Centre Summary Report</b>(<span style="color:yellow;">{{$req_month}}</span>)</p>
...
<br> <br>
<div class="footer1">
  <p>{{date("Y F", strtotime($req_month))}} Economic Centre Total Payment Recived  <span style="color:yellow;font-size: 25px;font-weight: bold;">Rs. {{ number_format($ecentre_income , 2)}}</span></p>
</div>
