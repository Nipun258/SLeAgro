               	...
               	<div class="col-xl-4 col-6">
					...
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								<p class="text-white mt-20 mb-0 font-size-16">Buyer buying Product Report(Day)</p>
								<h2 class="text-success mb-0 font-weight-500"> <!-- <small class="text-success"><i class="fa fa-caret-up"></i> +50%</small> --></h2>
							</div>
						</div>
					</div>
			  ...
			  <div class="col-xl-4 col-6">
					...
					<div class="box overflow-hidden pull-up">
						<div class="box-body">							
							...
							<div>
								<p class="text-white mt-20 mb-0 font-size-16">Buyer Buying Product Report(Month)</p>
								<h2 class="text-success mb-0 font-weight-500"> <!-- <small class="text-success"><i class="fa fa-caret-up"></i> +50%</small> --></h2>
							</div>
						</div>
					</div>
