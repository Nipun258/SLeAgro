...
<p>Name : {{ $buyer->name}}</p>
<p>Phone : {{ $buyer->mobile}}</p>
<p>Email : {{ $buyer->email}}</p>
<p>Collection Centre : {{ $buyer->centre_name}}</p>
    @endforeach
    </td> 
  </tr>
...
<div class="footer">
  <p><b>Buyer Payment Summary List</b>(<span style="color:yellow;">{{$req_month}}</span>)</p>
</div>
<br>
<table id="customers">
  <tr>
...
<br> <br>
<div class="footer1">
  <p>{{date("Y F", strtotime($req_month))}} Buyer Total Payment  <span style="color:yellow;font-size: 25px;font-weight: bold;">Rs. {{ number_format($total_payments , 2)}}</span></p>
</div>
