...
<br> <br>
<div class="footer1">
  <p>{{date("Y F", strtotime($req_month))}} Economic Centre total product Value <span style="color:yellow;font-size: 25px;font-weight: bold;">Rs. {{ number_format($total_payments , 2)}}</span></p>
</div>
