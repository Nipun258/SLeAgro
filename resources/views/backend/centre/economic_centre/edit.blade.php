		...
		<section class="content">
			...
			<div class="box">
				<div class="box-header with-border">
					<h4 class="box-title">Edit Economic Centre Data</h4>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					<div class="row">
						<div class="col">
							<form method="post" action="{{ route('ecomomic.centre.update',$editData->id) }}" >
...
<div class="col-md-6" >
 ...
 <div class="form-group">
	<h5>Center Type <span class="text-danger">*</span></h5>
	<div class="controls">
	 <select name="centre_type" id="centre_type" class="form-control">
			<option value="" selected="" disabled="">Select Centre Type</option>
            <option value="A" {{($editData->centre_type == "A" ? "selected" : "")}}>Type A</option>
            <option value="B" {{($editData->centre_type == "B" ? "selected" : "")}}>Type B</option>	 
		</select>
		<span class="text-danger">@error('centre_type'){{$message}}@enderror</span>
	 </div>
          </div>
	</div> <!-- End Col Md-6 -->
